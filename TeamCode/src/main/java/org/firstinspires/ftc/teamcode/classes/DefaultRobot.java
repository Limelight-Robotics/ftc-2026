...
public class DefaultRobot
{
    ...
    public String getLoaderInitError() { return loaderInitError; }
    ...
    public void raiseLoader() { setLoaderPower(LOADER_MOTOR_POWER); }

    public void lowerLoader() { setLoaderPower(-LOADER_MOTOR_POWER); }

    public void stopLoader() { setLoaderPower(0.0); }
