 ...
 * Replace placeholder values with empirically measured {distance_meters, rpm} pairs.
 */
public final class LauncherHelper {
     ...
     * Fill these in from testing — set launcher to known RPM, measure landing distance.
     */
