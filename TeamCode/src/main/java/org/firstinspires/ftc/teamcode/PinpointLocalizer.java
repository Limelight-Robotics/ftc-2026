...
@Config public final class PinpointLocalizer implements Localizer
{
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose)
    {
        ...
        driver.setOffsets(
            mmPerTick * PARAMS.parYTicks, mmPerTick * PARAMS.perpXTicks, DistanceUnit.MM);
    ...
    @Override public void setPose(Pose2d pose)
    {
        txWorldPinpoint = pose.times(txPinpointRobot.inverse());
    }

    @Override public Pose2d getPose() { return txWorldPinpoint.times(txPinpointRobot); }
    ...
    @Override public PoseVelocity2d update()
    {
        ...
        {
            txPinpointRobot =
                new Pose2d(driver.getPosX(DistanceUnit.INCH), driver.getPosY(DistanceUnit.INCH),
