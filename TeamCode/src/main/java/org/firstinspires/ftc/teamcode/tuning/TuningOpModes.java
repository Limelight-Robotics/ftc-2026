...
public final class TuningOpModes
{
    ...
    private static PinpointView makePinpointView(PinpointLocalizer pl)
    {
        return new PinpointView() {
            ...
            @Override public int getParEncoderPosition()
            {
                return pl.driver.getEncoderX();
            }

            @Override public int getPerpEncoderPosition()
            {
                return pl.driver.getEncoderY();
            }

            @Override public float getHeadingVelocity(UnnormalizedAngleUnit unit)
            {
                return (float) pl.driver.getHeadingVelocity(unit);
            }

            @Override public void setParDirection(@NonNull DcMotorSimple.Direction direction)
            {
            ...
            @Override public DcMotorSimple.Direction getParDirection()
            {
            ...
            @Override public void setPerpDirection(@NonNull DcMotorSimple.Direction direction)
            {
            ...
            @Override public DcMotorSimple.Direction getPerpDirection()
            {
    ...
    @OpModeRegistrar public static void register(OpModeManager manager)
    {
        if (DISABLED)
            return;
        ...
        if (DRIVE_CLASS.equals(MecanumDrive.class))
        {
            dvf = hardwareMap ->
            {
                ...
                if (md.localizer instanceof MecanumDrive.DriveLocalizer)
                {
                    ...
                    encoderGroups.add(
                        new LynxQuadratureEncoderGroup(hardwareMap.getAll(LynxModule.class),
                ...
                return new DriveView(DriveType.MECANUM, MecanumDrive.PARAMS.inPerTick,
                    ...
                    MecanumDrive.PARAMS.maxProfileAccel, encoderGroups,
                    Arrays.asList(md.leftFront, md.leftBack),
                    Arrays.asList(md.rightFront, md.rightBack), leftEncs, rightEncs, parEncs,
        ...
        else if (DRIVE_CLASS.equals(TankDrive.class))
        {
            dvf = hardwareMap ->
            {
                ...
                return new DriveView(DriveType.TANK, TankDrive.PARAMS.inPerTick,
                    ...
                    TankDrive.PARAMS.maxProfileAccel, encoderGroups, td.leftMotors, td.rightMotors,
                    leftEncs, rightEncs, parEncs, perpEncs, lazyImu, td.voltageSensor,
                    ()
